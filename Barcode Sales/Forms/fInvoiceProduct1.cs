...
{
    public partial class fInvoiceProduct1 : FormBase
    {
        ...
        {
            fSelectedProduct<fInvoiceProduct1> selectedProduct = new fSelectedProduct<fInvoiceProduct1>(this);
