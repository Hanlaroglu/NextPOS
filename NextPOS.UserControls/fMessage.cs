using NextPOS.UserControls.Properties;
using System;
...
namespace NextPOS.UserControls
{
    public partial class fMessage : Form
    {
        ...
        private fMessage.enmAction action;
            ...
            switch (this.action)
            {
                ...
                case fMessage.enmAction.start:
                    ...
                    else
                    {
                        if (this.Opacity == 1.0)
                        {
                            action = fMessage.enmAction.wait;
                        }
                    }
                    break;
        ...
        public void showAlert(string msg, enmType type)
        {
            ...
            for (int i = 1; i < 10; i++)
            {
                ...
                fMessage frm = (fMessage)Application.OpenForms[fname];
